...
import argparse
import torch
from data.cloudperu2_dataset import CloudPeru2Dataset
from utils.utils import cv2_imshow, fitness_test
...
def train(opt):
    ...
    # Train dataset
    train_dataset = CloudPeru2Dataset('./data', train=True)
    # Train dataloader
    ...
    # Validation dataset
    val_dataset = CloudPeru2Dataset('./data', train=False)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--name', default='my_vgg11', help='name for the run')
